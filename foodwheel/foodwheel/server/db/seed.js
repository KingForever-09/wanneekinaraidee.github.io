...
const FOODS = {
  ...
  rice: [
    ...
    { name: 'Biryani (บิรยานี)', kcal: 600, protein: 24, carbs: 70, fat: 22, benefit: 'เครื่องเทศอย่างขมิ้นและอบเชยมีสารต้านการอักเสบ', img: '' },
    { name: 'Paella (ปาเอย่า)', kcal: 540, protein: 26, carbs: 60, fat: 18, benefit: 'อาหารทะเลให้สังกะสีและซีลีเนียมเสริมภูมิคุ้มกัน', img: '' },
    { name: 'Risotto', kcal: 480, protein: 12, carbs: 62, fat: 18, benefit: 'ชีสพาร์เมซานให้แคลเซียมและโปรตีนคุณภาพดี', img: '' },
    ...
    { name: 'Jollof Rice', kcal: 470, protein: 13, carbs: 70, fat: 14, benefit: 'มะเขือเทศอุดมไลโคปีนช่วยต้านอนุมูลอิสระ', img: '' },
    ...
    { name: 'Jambalaya', kcal: 540, protein: 25, carbs: 58, fat: 18, benefit: 'ไส้กรอกและกุ้งให้โปรตีนและธาตุเหล็กสูง', img: '' },
    { name: 'Onigiri (โอนิกิริ)', kcal: 180, protein: 4, carbs: 38, fat: 1, benefit: 'แคลอรีต่ำ พกพาง่าย เหมาะเป็นของว่างให้พลังงานเร็ว', img: '' },
    { name: 'Arroz con Pollo', kcal: 520, protein: 28, carbs: 58, fat: 18, benefit: 'ไก่และข้าวให้พลังงานและโปรตีนสมดุลในจานเดียว', img: '' },
    { name: 'Pulao', kcal: 430, protein: 11, carbs: 62, fat: 14, benefit: 'เครื่องเทศหอมช่วยกระตุ้นระบบย่อยอาหาร', img: '' },
    { name: 'Pilaf', kcal: 410, protein: 10, carbs: 64, fat: 12, benefit: 'ถั่วและลูกเกดเสริมใยอาหารและธาตุเหล็ก', img: '' },
    ...
    { name: 'Tahdig (ทาห์ดิก)', kcal: 460, protein: 9, carbs: 70, fat: 14, benefit: 'ข้าวกรอบทอดให้พลังงานสูง เหมาะเป็นมื้อพิเศษ', img: '' },
  ],
  sweets: [
